...
var grass = { "ID": 40, "NAME": "grass", "COLOR": colors.green, "RESSOURCES": []}
var pavement = { "ID": 41, "NAME": "pavement", "COLOR": colors.grey, "RESSOURCES": []}
...
var decorations = {"GRASS": grass, "PAVEMENT": pavement }